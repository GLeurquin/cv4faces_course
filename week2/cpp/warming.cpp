...
int main(int argc, char ** argv)
{
  ...
  namedWindow("Original Image   --   Warming filter output",CV_WINDOW_AUTOSIZE);
  imshow("Original Image   --   Warming filter output",combined); 
  cv::imwrite("results/warming.jpg",output);
