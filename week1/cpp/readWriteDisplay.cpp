...
int main(void)
{
	...
	String imageName( "../../data/images/sample.jpg" ); // by default
	...
	// SAVE image
	imwrite("results/result.jpg", image);  // it will store the image with name "result.jpg"
	imwrite("results/result_gray.jpg", grayImage); // it will store the gray image with name "result_gray.jpg"
